export default function AboutText() {
 ...
 <div className="w-full max-w-4xl md:max-w-2xl">
      <p className="text-lg text-gray-700 leading-relaxed">
        ...
        live production environment on a <strong className="font-bold text-zinc-900">B2B SaaS platform</strong>,
        I shipped real features across the entire stack with <strong className="font-bold text-zinc-900">PHP</strong> and <strong className="font-bold text-zinc-900">JavaScript</strong>.
        <br /><br />
        For my thesis, I built a complete event management platform from the ground up
        using <strong className="font-bold text-zinc-900">C#</strong>, <strong className="font-bold text-zinc-900">ASP.NET Core</strong>,
        and <strong className="font-bold text-zinc-900">Entity Framework</strong>, using <strong className="font-bold text-zinc-900">SQL</strong> for data management and <strong className="font-bold text-zinc-900">Azure</strong> for cloud deployment. I love the challenge of writing business-critical code and navigating complex architecture, which is also why I am currently diving deep into <strong className="font-bold text-zinc-900">TypeScript</strong> to build even more robust and scalable front-end applications.
        <br /><br />
