  ...
  return (
    <div className="w-full max-w-4xl md:max-w-2xl">
      <p className="text-lg text-gray-700 leading-relaxed">
        Hi, I'm [Your Name]. I recently graduated as a Fullstack Developer, but my journey here isn't the typical one.
        Before diving into <strong className="font-bold text-zinc-900">web development</strong>,
        I spent 12 years working as an educator and team leader.
        <br /><br />
        ...
        and <strong className="font-bold text-zinc-900">Entity Framework</strong>. I love the challenge of writing business-critical code and navigating complex architecture.
        <br /><br />
