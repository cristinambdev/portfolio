export default function AboutText() {
 ...
 <div className="w-full max-w-4xl md:max-w-2xl">
      <p className="text-lg text-gray-700 dark:text-zinc-300 leading-relaxed">
        ...
        and <strong className="font-bold text-zinc-900 dark:text-zinc-100">Entity Framework</strong>, using <strong className="font-bold text-zinc-900 dark:text-zinc-100">SQL</strong> for data management and <strong className="font-bold text-zinc-900 dark:text-zinc-100">Azure</strong> for cloud deployment. I love the challenge of writing business-critical code and navigating complex architecture, which is also why I am currently diving deep into <strong className="font-bold text-zinc-900 dark:text-zinc-100">TypeScript</strong> to build even more robust and scalable front-end applications.
        <br /><br />
